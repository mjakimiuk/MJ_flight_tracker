...
class Airlines_database(db.Model):  # SQLalchemy model
    __tablename__ = "airlines_database"
    index = db.Column(db.String(100), unique=False, nullable=False, primary_key=True)
    icao_code = db.Column(db.String(100), unique=False, nullable=False)
    iata_code = db.Column(db.String(100), unique=False, nullable=False)
    name = db.Column(db.String(100), unique=False, nullable=False)
